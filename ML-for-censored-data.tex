...
\hspace{1em}{\bf{Discard-Tree}}    & Classification tree on subjects with $\delta=1$ or $\delta=0$ and $V\geq 5$                                                                            \\
...
\hspace{1em}{\bf{Zero-Tree}}    & Classification tree using event indicator $\delta$                                                                            \\
...
\hspace{1em}{\bf{IPCW-Tree}}    & Classification tree with inverse probability of censoring weights                                                 \\
