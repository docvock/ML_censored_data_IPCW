...
\begin{table}[ht]
\centering
\tbl{Calibration statistic and C-index of the models described in Table~\ref{table:modelDisc}, evaluated on the hold-out test set. {\em{Predicted event rate}}: Average predicted probability of experiencing a CV event within 5 years;  {\em{Calibration}}: calibration test statistic K; {\em{C-index}}: Concordance index;  \label{table:calib-cindex} }{%
\begin{tabular}{lccc}
